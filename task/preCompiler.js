...
let toLazyLoad = function (symbol, sourceDir, targetFile, module_name) {
...
module.exports = function () {
    ...
    // 弹框
    toLazyLoad('dialogs', './src/views/dialogs', './src/views/lazy-load-dialog.js', '弹框');

    // 交易
    toLazyLoad('contents', './src/views/contents', './src/views/lazy-load-content.js', '内容');
